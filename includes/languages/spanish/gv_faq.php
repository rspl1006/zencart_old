...
// +----------------------------------------------------------------------+
// $Id: gv_faq.php,v 1.2 2006/01/10 18:23:43 gorkau Exp $
//
...
define('SUB_HEADING_TEXT', 'Los ' . TEXT_GV_NAMES . ' se compran como cualquier otro artítulo de nuestra tienda. Los puede
  ...
  link a la página donde podrá enviar el ' . TEXT_GV_NAME . ' a alguien por email.');
  break;
  case '2':define('TEXT_GV_REDEEM_INFO', 'Please enter your ' . TEXT_GV_NAME . ' redemption code: ');
define('TEXT_GV_REDEEM_ID', 'Redemption Code:');
define('SUB_HEADING_TITLE', 'Cómo enviar ' . TEXT_GV_NAMES);
define('SUB_HEADING_TEXT', 'Para enviar un ' . TEXT_GV_NAME . ' necesitará ia a nuestra Página de enviar ' . TEXT_GV_NAME . '. Puede
  ...
  comprar otros artículos de nuestra tienda. Al momento del pago aparecerá un recuadro
  extra. Ingrese la cantidad a aplicar de los fondos en su Cuenta de ' . TEXT_GV_NAME . '.
  ...
  Esto lo llevará a la página de Canje de ' . TEXT_GV_NAME . ' de la tienda. Se le pedirá que
...
habrá un recaudro para ingresar un ' . TEXT_GV_REDEEM . ' del ' . TEXT_GV_NAME . '.  Ingrese el ' . TEXT_GV_REDEEM . ' aquí, y
pulse el botón de canjear. El ' . TEXT_GV_REDEEM . ' será
validado y sumado a su cuenta de ' . TEXT_GV_NAME . '. Usted podrá, entonces, usar esa cantidad para comprar cualquier artículo de nuestra tienda.');
  break;
  case '5':
  define('SUB_HEADING_TITLE', 'Cuando hay problemas');
  define('SUB_HEADING_TEXT', 'Por cualquier pregunta relacionada con el Sistema de ' . TEXT_GV_NAME . ', por favor, contacte a la tienda

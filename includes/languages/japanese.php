...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', '井幡侭嗤 &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.cn" target="_blank">Zen Cart</a>');
...
// on Windows try 'en', or 'English'
  ...
  define('DATE_FORMAT_LONG', '%Y定%m埖%d晩'); // this is used for strftime()
...
// payment method is GV/Discount
  ...
  define('TEXT_INVALID_USES_COUPON', 'このクーポンは');
  define('TIMES', '回使えます');
  define('TIME', ' 回使えます');
  define('TEXT_INVALID_USES_USER_COUPON', 'クーポンコード: %s の最大使用回数に達しました。');
...
// text pricing
  ...
  define('TEXT_ATTRIBUTES_QTY_PRICES_ONETIME_HELP', '基本料数量割引オプション');

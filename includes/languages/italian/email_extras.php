...
// email disclaimer
  ...
  define('EMAIL_SPAM_DISCLAIMER','Se non desideri più ricevere questa email puoi richiedere la rimozione a questo indirizzo.');
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>. Powered by <a href="http://www.zencart-italia.it" target="_blank">Zen Cart Italia</a>');

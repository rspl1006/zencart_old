...
define('EMAIL_DISCLAIMER_NEW_CUSTOMER', 'Questo indirizzo e-mail ci è stato fornito da uno dei nostri Clienti. Se però non intendi creare un account, o se questa e-mail ti è giunta per sbaglio, ti preghiamo di inviare una e-mail a %s ');

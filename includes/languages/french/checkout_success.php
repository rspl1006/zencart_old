 ...
 */
  ...
  define('TEXT_SEE_ORDERS', 'Vous pouvez consulter votre historoire de commandes en vous rendant sur la page <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">Mon Compte</a> et en cliquant sur "Voir toutes les commandes".');
...
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', 'Merci de votre achat. Veuillez cliquer sur le lien "Se d&eacute;connecter" pour s\'assurer que vos informations d\'achat ne seront pas visibles par une personne qui utiliserait votre ordinateur apr&egrave;s vous.');
?>
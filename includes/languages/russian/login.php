...
define('HEADING_NEW_CUSTOMER', 'Новенький? Введите информацию о себе');
define('TEXT_NEW_CUSTOMER_INTRODUCTION', 'Создав свой профиль в ' . STORE_NAME . ' вы можете быстрее совершать покупки,просматривать историю покупок,создавать несколько адресов доставки и пользоватся скидками');

define('HEADING_RETURNING_CUSTOMER', 'Если вы клиент: пожалуйста войдите в систему');
...
define('TEXT_LOGIN_ERROR', 'Ошибка: Извините,но в нашей базе нет данных о таком клиенте');
define('TEXT_VISITORS_CART', '<strong>Внимание:</strong> Ваша &quot;Корзина посетителя&quot; и её содержимое будет перенесено в &quot;Корзину клиента&quot; как только вы войдете в систему. <a href="javascript:session_win();">[Подробнее]</a>');
define('TEXT_PASSWORD_FORGOTTEN', 'Forgot your password?');

define('TABLE_HEADING_PRIVACY_CONDITIONS', '<span class="privacyconditions">Гарантии секретности</span>');
define('TEXT_PRIVACY_CONDITIONS_DESCRIPTION', '<span class="privacydescription">Вы должны знать,что соглашаетесь со всеми условиями, утверждая это переходом на следующую страницу. Гарантии секретности вы можете узнать</span> <a href="' . zen_href_link(FILENAME_PRIVACY, '', 'SSL') . '"><span class="pseudolink">здесь</span></a>.');

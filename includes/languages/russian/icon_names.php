...
define('ICON_TRASH_ALT', 'Удалите этот пункт нажав на данную иконку');
define('ICON_UPDATE_ALT', 'Обновление Корзина');
define('ICON_TINYCART_ALT', 'Добавь этот товар В корзину нажимая тут.');

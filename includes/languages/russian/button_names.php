...
define('BUTTON_LOGIN_ALT', 'Войти в систему');
define('BUTTON_NEXT_ALT', 'Далее');
define('BUTTON_PREVIOUS_ALT', 'Предидущее');
define('BUTTON_REDEEM_ALT', 'Предложение');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Вернутся к списку товаров');
...
define('BUTTON_SEND_ANOTHER_ALT', 'Отправить другой подарочный сертификат');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Отправить подарочный сертификат');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Стоимость Пересылки');
define('BUTTON_SOLD_OUT_ALT', 'Продано');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Продано');
define('BUTTON_SUBMIT_ALT', 'Отправить информацию');
define('BUTTON_TELL_A_FRIEND_ALT', 'Рассказать знакомому');
define('BUTTON_TELLAFRIEND_ALT', 'Рассказать знакомому');
define('BUTTON_UNSUBSCRIBE', 'Отписатся');
define('BUTTON_UPDATE_ALT', 'Обновить');
define('BUTTON_VIEW_SMALL_ALT', 'Просмотр');
define('BUTTON_WRITE_REVIEW_ALT', 'Написать отзыв');
define('BUTTON_READ_REVIEWS_ALT', 'Читать отзыв');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Перейти к информации о товаре');
define('BUTTON_MORE_REVIEWS_ALT', 'Читать все отзывы');
?>
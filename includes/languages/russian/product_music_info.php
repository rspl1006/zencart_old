...
define('TEXT_RECORD_COMPANY_URL', 'Для более подробной информации, посетите странцу <a href="%s" target="_blank">звукозаписывающих компаний</a>.');
define('TEXT_ARTIST_URL', 'Для более подробной информации, посетите страницу <a href="%s" target="_blank">исполнителя</a>.');
...
define('TEXT_PRODUCT_RECORD_COMPANY', 'Звукозаписывающая компания: ');
define('TEXT_PRODUCT_ARTIST', 'Исполнитель: ');
define('TEXT_PRODUCT_MUSIC_GENRE', 'Стиль: ');
define('TEXT_PRODUCT_WEIGHT', 'Вес товара: ');
define('TEXT_PRODUCT_QUANTITY', ' Количество в запасе');
define('TEXT_PRODUCT_MODEL', 'Модель: ');
define('TEXT_PRODUCT_COLLECTIONS', 'Медиа коллекция: ');

...
define('MAIN_MESSAGE', '您正在发送的' . TEXT_GV_NAME . '价值为%s到%s，电子邮件地址为%s。如果不正确，请点击<strong>编辑</strong>按钮修改。<br /><br />您正在发送的内容为:<br /><br />');
define('SECONDARY_MESSAGE', '亲爱的%s，<br /><br />' . '您发送了一张' . TEXT_GV_NAME . '，价值%s，通过%s');
...
define('EMAIL_GV_TEXT_HEADER', '恭喜，您收到了一份' . TEXT_GV_NAME . '，价值%s');
define('EMAIL_GV_FROM', '该' . TEXT_GV_NAME . '来自%s');
define('EMAIL_GV_MESSAGE', '留言内容: ');
define('EMAIL_GV_SEND_TO', '您好，%s');
define('EMAIL_GV_REDEEM', '要兑现该' . TEXT_GV_NAME . '，请点击下面的链接。同时记下' . TEXT_GV_REDEEM . ': %s  已备查询。');

 ...
 */
  ...
  if (MODULE_PAYMENT_AUTHORIZENET_STATUS == 'True') {
    define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION', '<a target="_blank" href="https://account.authorize.net/">Authorize.net商户登录</a>' . (MODULE_PAYMENT_AUTHORIZENET_TESTMODE != 'Production' ? '<br /><br />测试信息:<br /><b>自动批准的信用卡号码:</b><br />Visa#: 4007000000027<br />MC#: 5424000000000015<br />Discover#: 6011000000000012<br />AMEX#: 370000000000002<br /><br /><b>说明:</b> 这些卡号在正式运行模式下会被拒绝，在测试模式下可以通过。有效期可以是任何今后的日期，CVV校验码可以是任何3或4 (AMEX)位数字。<br /><br /><b>自动拒绝的信用卡号:</b><br /><br />Card #: 4222222222222<br /><br />这个卡号可用于测试接收拒绝通知。<br /><br />' : ''));
  } else { 
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_TEXT_DESCRIPTION', '信用卡测试信息:<br /><br />CC#: 4111111111111111<br />有效期: 任意');

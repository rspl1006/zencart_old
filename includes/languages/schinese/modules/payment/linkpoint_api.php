 ...
 */
  ...
  define('MODULE_PAYMENT_LINKPOINT_API_TEXT_ADMIN_TITLE', 'Linkpoint/YourPay 接口');
  ...
  if (defined('MODULE_PAYMENT_LINKPOINT_API_STATUS') && MODULE_PAYMENT_LINKPOINT_API_STATUS == 'True') {
    define('MODULE_PAYMENT_LINKPOINT_API_TEXT_DESCRIPTION', '<a target="_blank" href="https://secure.linkpt.net/lpcentral/servlet/LPCLogin">Linkpoint/YourPay 商户登录</a>' . (MODULE_PAYMENT_LINKPOINT_API_TRANSACTION_MODE_RESPONSE != 'LIVE: Production' ? '<br /><br /><strong>Linkpoint/YourPay API 测试卡号:</strong><br /><strong>Visa:</strong> 4111111111111111<br /><strong>MasterCard:</strong> 5419840000000003<br /><strong>Amex:</strong> 371111111111111<br /><strong>Discover:</strong> 6011111111111111' : '') . '<br /><a target="_blank" href="http://tutorials.zen-cart.com/index.php?article=298">排错/安装说明</a>');
  } else { 
  define('MODULE_PAYMENT_LINKPOINT_API_TEXT_DESCRIPTION', '<a target="_blank" href="http://www.zen-cart.com/index.php?main_page=infopages&pages_id=30">点击这里开户</a><br /><br /><a target="_blank" href="https://secure.linkpt.net/lpcentral/servlet/LPCLogin">Linkpoint/YourPay 商户页面</a><br /><br /><a target="_blank" href="http://tutorials.zen-cart.com/index.php?article=298"><strong>安装/排错说明</strong>点这里</a><br /><br /><strong>Requirements:</strong><br /><hr />*<strong>LinkPoint 或 YourPay 账户</strong> (见上面的注册链接)<br />*<strong>需要cURL</strong>且必须编译到PHP中<br />*<strong>Port 1129</strong>用于和网关间的双向通讯，必须在主机的路由器/防火墙上打开。<br />*<strong>PEM RSA Key File </strong>数字证书:<br />要获得并上传数字证书(.PEM) key:<br />- 登录您的LinkPoint/Yourpay 账户<br />- 点击主菜单下的 "Support"。<br />- 点击边框菜单中下载区的 "Download Center" 。<br />- 点击 "Store PEM File" 边上的 "download"<br />- 输入相应信息开始下载。需要提供提供注册商业商号时提交的 SSN 或 Tax ID。<br />- 上传该文件到 includes/modules/payment/linkpoint_api/XXXXXX.pem (由LinkPoint提供 - xxxxxx 是您的商店编号)');
  }
  ...
  define('MODULE_PAYMENT_LINKPOINT_API_TEXT_ERROR_CURL_NOT_FOUND', '没有找到CURL功能 - Linkpoint API支付模块要求该功能');

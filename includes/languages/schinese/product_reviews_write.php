...
define('SUB_TITLE_REVIEW', '请和大家分享您的想法，仅与商品有关的内容。');
define('SUB_TITLE_RATING', '评价该商品。一颗星最差，五颗星最好。');

define('TEXT_NO_HTML', '<strong>说明:</strong> 不能使用HTML标签。');
define('TEXT_BAD', '最差');
define('TEXT_GOOD', '最好');
define('TEXT_PRODUCT_INFO', '');

define('TEXT_APPROVAL_REQUIRED', '<strong>说明:</strong> 评论经审核后才显示');

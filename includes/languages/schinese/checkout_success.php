...
define('TEXT_SEE_ORDERS', '要查询订单记录，请到<a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">我的帐号</a>页面点击查看所有订单。');
define('TEXT_CONTACT_STORE_OWNER', '如有任何疑问，请到<a href="' . zen_href_link(FILENAME_CONTACT_US) . '">客户服务中心</a>。');

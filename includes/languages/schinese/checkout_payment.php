...
define('TEXT_CONDITIONS_DESCRIPTION', '<span class="termsdescription">请点击下面的方框表明您同意本店顾客须知中的条款。该顾客须知在<a href="' . zen_href_link(FILENAME_CONDITIONS, '', 'SSL') . '"><span class="pseudolink">这里</span></a>。');

 ...
 * @version $Id: schinese.php 7440 2007-12-07 Jack $
...
// whats_new box text in sideboxes/whats_new.php
  ...
  define('TEXT_NO_ALL_PRODUCTS', '即将发布更多商品，请稍后再查询。');
...
// reviews box text in sideboxes/reviews.php
  ...
  define('BOX_REVIEWS_WRITE_REVIEW', '撰写评论');
...
// End iii added
  ...
  define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', '通知: 网站维护, 即将关闭时间(日/月/年) (hh-hh)：');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_UPCOMING_PRODUCTS', '即将上市商品');
  ...
  define('SUMMARY_TABLE_UPCOMING_PRODUCTS','表中含即将到货的商品清单以及预计到货时间');
...
// set for login for prices
  define('TEXT_LOGIN_FOR_PRICE_PRICE','标价不显示');
...
// authorization pending
  define('TEXT_AUTHORIZATION_PENDING_PRICE', '标价不显示');
  define('TEXT_AUTHORIZATION_PENDING_BUTTON_REPLACE', '审核等待中');
  define('TEXT_LOGIN_TO_SHOP_BUTTON_REPLACE','登录商店');
...
// sort order titles for dropdowns
  ...
  define('TEXT_INFO_SORT_BY_PRODUCTS_NAME', '商品名称');
  define('TEXT_INFO_SORT_BY_PRODUCTS_NAME_DESC', '商品名称 - 降序');
  define('TEXT_INFO_SORT_BY_PRODUCTS_PRICE', '价格 - 低到高');
  define('TEXT_INFO_SORT_BY_PRODUCTS_PRICE_DESC', '价格 - 高到低');
  define('TEXT_INFO_SORT_BY_PRODUCTS_MODEL', '型号');
  define('TEXT_INFO_SORT_BY_PRODUCTS_DATE_DESC', '添加日期 - 新到旧');
  define('TEXT_INFO_SORT_BY_PRODUCTS_DATE', '添加日期 - 旧到新');

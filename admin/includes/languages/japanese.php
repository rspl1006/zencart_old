...
define('BOX_GV_ADMIN_QUEUE',  TEXT_GV_NAMES . '承認待ち');
...
// Version Check notices
  ...
  define('TEXT_VERSION_CHECK_DOWNLOAD','ここにダウンロード');
...
// toggle on/off
  ...
  define('TEXT_IMAGES_OVERWRITE', '既存のイメージを上書きしますか? Use No for manually typed names');
  define('TEXT_IMAGE_OVERWRITE_WARNING','警告: FILENAMEをアップデートしましたが、上書きできませんでした。 ');

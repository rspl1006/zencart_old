...
// +----------------------------------------------------------------------+
//  $Id: sqlpatch.php 3093 2006-03-02 19:50:40Z Albigin $
//
  ...
  define('HEADING_WARNING2','Chi installa contributi di una terza parte lo fa a proprio rischio.<br />Zen Cart&trade; non rilascia garanzie quanto alla sicurezza di script forniti da terzi. Testare prima di utilizzarli su un database in uso!');
    define('HEADING_WARNING_INSTALLSCRIPTS', 'NOTA: Gli scripts di upgrade del database di Zen Cart non dovrebbero essere eseguiti tramite questa pagina.<br />Trasferisci via FTP la nuova cartella <strong>zc_install</strong> ed esegui l\'upgrade da lì.');

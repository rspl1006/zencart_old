...
// +----------------------------------------------------------------------+
//  $Id: salemaker.php 1105 2005-04-04 22:05:35Z Albigin $
//
...
define('TEXT_SALEMAKER_POPUP', '<a href="javascript:session_win();"><span class="errorText"><b>Clicca per consigli sull\' uso di FareSaldi.</b></span></a>');
...
define('TEXT_INFO_DELETE_INTRO', 'Davvero vuoi cancellare permanentemente questo saldo?');
?>
...
define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', 'Errore: la cartella dei grafici NON esiste. Crearne una, esempio: <strong>' . DIR_WS_ADMIN . 'immagini/grafici</strong>');
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', 'Errore: la cartella dei grafici NON &egrave; scrivibile.');
?>
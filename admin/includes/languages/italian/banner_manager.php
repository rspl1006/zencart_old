...
define('TEXT_BANNERS_BANNER_NOTE', '<b>Note Banner:</b><ul><li>Usare un\'immagine OPPURE un testo HTML per il banner - non entrambi.</li><li>Il Testo HTML ha prioriet&agrave; rispetto all\'immagine!</li></ul>');
define('TEXT_BANNERS_INSERT_NOTE', '<b>Note Immagini:</b><u>Le cartelle di Upload devono essere dotate degli opportuni permessi di scrittura!</u>');

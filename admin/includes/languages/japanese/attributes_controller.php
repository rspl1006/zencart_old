...
define('TEXT_PRICES_AND_WEIGHTS', '価格と重量');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR', 'プライスファクター ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET', 'オフセット: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_ONETIME', '一回:');

define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_ONETIME', '一回のファクター: ');
define('TABLE_HEADING_ATTRIBUTES_PRICE_FACTOR_OFFSET_ONETIME', 'オフセット: ');

define('TABLE_HEADING_ATTRIBUTES_QTY_PRICES', 'アトリビュートの大量購入による値引き:');
define('TABLE_HEADING_ATTRIBUTES_QTY_PRICES_ONETIME', '一回だけのアトリビュートの大量購入による値引き:');

define('TABLE_HEADING_ATTRIBUTES_PRICE_WORDS', '言葉ごとの価格？:');
//Price Per Word
define('TABLE_HEADING_ATTRIBUTES_PRICE_WORDS_FREE', '無料の言葉？:');
//- Free Words
define('TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS', '文字ごとの価格？:');
//Price Per Letter
define('TABLE_HEADING_ATTRIBUTES_PRICE_LETTERS_FREE', '無料の文字？:');
//- Free Letters
...
define('TABLE_HEADING_PRICE_TOTAL','値引き合計　一度のみ？');
//Total|Disc: Onetime:
...
define('TABLE_TEXT_MAX_COUNT_SHORT', '最大:');
  ...
  define('TEXT_ATTRIBUTES_IMAGE','属性の見本画像:');
  define('TEXT_ATTRIBUTES_IMAGE_DIR','属性の見本画像ディレクトリ:');

  define('TEXT_ATTRIBUTES_FLAGS','属性<br />フラグ:');
  define('TEXT_ATTRIBUTES_DISPLAY_ONLY', '表示のみ:');
  define('TEXT_ATTRIBUTES_IS_FREE', '商品が無料のとき<br/>属性による価格も無料にする:');
  define('TEXT_ATTRIBUTES_DEFAULT', 'デフォルトで<br />選択される:');
  define('TEXT_ATTRIBUTE_IS_DISCOUNTED', '特価商品/セールによって<br />割引を適用する:');
  define('TEXT_ATTRIBUTE_PRICE_BASE_INCLUDED','属性によって価格がつけられるとき<ba/>基本価格に含める');
  define('TEXT_ATTRIBUTES_REQUIRED','テキストに必要なアトリビュート');

  define('LEGEND_BOX','伝説:');
...
// preview
  ...
  define('TEXT_DELETE_ATTRIBUTES_OPTION_NAME_VALUES', 'オプション...の全てのオプション値を全て削除しますか？');
  ...
  define('SUCCESS_ATTRIBUTES_DELETED_OPTION_NAME_VALUES', 'オプション...の全てのオプション値を全て削除しました。: ');
?>
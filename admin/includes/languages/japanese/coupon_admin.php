...
define('TEXT_TO_REDEEM', '精算時にこのクーポン券と引き換えることができます。入力フォームにコードを入力し「引き換える」ボタンをクリックしてください。');
...
define('COUPON_FREE_SHIP_HELP', 'クーポン券使用時は配送料を無料にする。<BR>ノート： これはクーポンの利用額に関係なく適用されますが、利用最低額は適用されます。');

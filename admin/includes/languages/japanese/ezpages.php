...
define('TABLE_HEADING_CHAPTER', 'チャプター:');
...
define('TEXT_CHAPTER', '前の/次の チャプター:');
define('TABLE_HEADING_CHAPTER_PREV_NEXT', 'チャプター:&nbsp;<br />');
...
define('TEXT_TOC_SORT_ORDER_EXPLAIN', 'コンテンツブロック (TOC)整列順はコンテンツブロックのエリアが一列に垂直に並んでいる時のみ使用できます。整列順はゼロより大きい数値を設定してください。');
define('TEXT_CHAPTER_EXPLAIN', 'チャプターはコンテンツブロック(TOC)と共に使用される表示順を前後に整列させるために使います。コンテンツブロック(TOC)の中のリンクは チャプターナンバーと対応していて、TOCの整列順に表示されるようになっています');
...
define('TEXT_SORT_CHAPTER_TOC_TITLE', 'チャプター/コンテンツブロック(TOC)');

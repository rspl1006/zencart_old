...
define('BOX_CATALOG_PRODUCTS_EXPECTED', '即将上市商品');
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>种商品)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCT_TYPES', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>种商品类型)');
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_EXPECTED', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>种即将上市商品)');
define('TEXT_DISPLAY_NUMBER_OF_REVIEWS', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>条商品评论)');
define('TEXT_DISPLAY_NUMBER_OF_SALES', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>种促销商品)');
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', '显示<b>%d</b>到<b>%d</b> (共<b>%d</b>种特价商品)');
...
define('TEXT_INFO_SET_MASTER_CATEGORIES_ID', '主分类编号无效');

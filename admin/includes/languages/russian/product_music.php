...
define('TEXT_PRODUCTS_RECORD_COMPANY', 'Звукозаписывающая компания:');
define('TEXT_PRODUCTS_MUSIC_GENRE', 'Стиль музыки:');
define('TEXT_PRODUCTS_PRICE_INFO', 'Цена:');
define('TEXT_PRODUCTS_TAX_CLASS', 'Налоговый класс:');
...
define('TEXT_DATE_AVAILABLE', 'Дата доступности:');
...
define('TEXT_DELETE_PRODUCT_INTRO', 'Вы точно хотите удалить данный товар?<br /><br /><strong>Внимание:</strong> На прилинкованные товары<br />1 Убедитесь что главная категория была изменена,если вы удаляете товар из нее<br />2 Проверьте из какой категории вы удаляете товар');

define('TEXT_DELETE_WARNING_CHILDS', '<b>WARNING:</b> %s (под-)категорий все ещё находятся в данной категории!');
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>WARNING:</b> %s товаров все ещё находятся в данной категории!');
...
define('TEXT_NEW_CATEGORY_INTRO', 'Введите необходимую информацию о новой категории');
...
define('TEXT_PRODUCTS_DATE_AVAILABLE', 'Дата наличия:');
define('TEXT_PRODUCT_AVAILABLE', 'В наличии');
define('TEXT_PRODUCT_NOT_AVAILABLE', 'Нет в наличии');
define('TEXT_PRODUCT_IS_VIRTUAL', 'Да, пропускать адрес отгрузки');
...
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', 'Скидка, Товар/Загрузка комбинация запрашивает адрес отгрузки');
define('TEXT_PRODUCTS_SORT_ORDER', 'Порядок сортировки:');

define('TEXT_PRODUCTS_QTY_BOX_STATUS_ON', 'Да, показывать количество');
define('TEXT_PRODUCTS_QTY_BOX_STATUS_OFF', 'Нет, не показывать количество');
...
define('TEXT_PRODUCTS_PRICE_NET', 'Цена (нетто):');
define('TEXT_PRODUCTS_PRICE_GROSS', 'Цена (брутто):');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Копировать любые медиа коллекции подходящие под данный товар');
  ...
  define('TEXT_COPY_ATTRIBUTES_CONDITIONS','<strong>Как должны быть обработаны созданные аттрибуты товаров?</strong>');
  define('TEXT_COPY_ATTRIBUTES_DELETE','<strong>Удалить</strong> сначала, потом копировать новые аттрибуты');
  define('TEXT_COPY_ATTRIBUTES_UPDATE','<strong>Обновить</strong> с новыйми настройками и ценами, потом добавить новый');
  define('TEXT_COPY_ATTRIBUTES_IGNORE','<strong>Пропустить</strong> и добавить только новый аттрибут');
  ...
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW','Внимание: Не показывать количество, умолчание количества 1');
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_EDIT','Внимание: Не показывать количество, умолчание количества 1');

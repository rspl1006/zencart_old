...
define('TEXT_DELETE_WARNING_PRODUCTS', '<b>Внимание:</b> %s товаров все ещё находятся в данной категории!');
...
// Products and Discount Copy Options
  define('TEXT_COPY_DISCOUNTS_ONLY','Только для продублированных товаров с дисконтом ...');
  define('TEXT_COPY_DISCOUNTS','Копировать дисконт товара на дубликат?');

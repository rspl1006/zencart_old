...
define('TEXT_PRODUCTS_IMAGE', 'Изображения:');
...
define('TEXT_PRODUCTS_WEIGHT', 'Вес отгрузки товара:');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_ATTRIBUTES_DELETE','Удалить</strong> сначала, потом копировать новые аттрибуты');

...
define('PRODUCTS_ATTRIBUTES_EDITING','编辑中'); // title
define('PRODUCTS_ATTRIBUTES_DELETE','删除中'); // title
...
define('TABLE_TEXT_MAX_COUNT_SHORT', '最多:');
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_PRODUCT','复制属性到另一<strong>商品</strong>');
  define('TEXT_INFO_ATTRIBUTES_FEATURE_COPY_TO','选择该商品复制所有属性到:');
...
// preview
  ...
  define('TEXT_SAVE_CHANGES','更新并保存:');
